                    ...
                    <form method="post" action="{{ route('posts.update', $post->id) }}" class="mt-6 space-y-6" enctype="multipart/form-data">
                        ...
                        <div>
                            ...
                            <div class="shrink-0 my-2">
                                <img id="featured_image_preview" class="h-64 w-128 object-cover rounded-md" src="{{ \Illuminate\Support\Facades\Storage::url($post->featured_image) }}" alt="Featured image preview" />
                            </div>
